...
import { urlImageContact, urlImageProduct } from "../../../config";
import { TbReload } from "react-icons/tb";
import { FaTrash } from "react-icons/fa";
import { Link } from "react-router-dom";
const DeleteTrashContact = () => {
  ...
  const handleStatus = (id) => {
    ...
    (async () => {
      const result = await ContactService.DeleteTrashcontact(contact, id);
      if (result.data.status === true) {
                  ...
                  if (contact.status === 0) {
                    return (
                      <tr className="datarow">
                        ...
                        <td>
                          <div className="name">
                            <Link href="brand_index.html"> {contact.name}</Link>
                          </div>
...
export default DeleteTrashContact;